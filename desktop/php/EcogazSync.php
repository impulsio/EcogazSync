...
<div class="row row-overflow">
    ...
    <div class="col-xs-12 eqLogicThumbnailDisplay">
        ...
        <div class="eqLogicThumbnailContainer">
            <div class="cursor eqLogicAction logoPrimary" data-action="refresh">
        ...
        <legend><i class="fas fa-table"></i> {{Mes API }}</legend>
        ...
        echo '<div class="eqLogicDisplayCard cursor '.$opacity.'" data-eqLogic_id="' . $eqLogic->getId() . '">';
                if (file_exists(dirname(__FILE__) . '/../../desktop/images/' . $eqLogic->getConfiguration('type') . '.png')) {
                    echo '<img src="plugins/EcogazSync/desktop/images/' . $eqLogic->getConfiguration('type') . '.png' . '" height="105" width="105" />';
                } else {
...
<?php
include_file('desktop', 'EcogazSync', 'js', 'EcogazSync');
