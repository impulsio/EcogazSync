$('.eqLogicAction[data-action=refreshEcogaz]').on('click', function () {
    $('#div_alert').showAlert({message: 'Synchronisation avec les API Ecogaz..', level: 'warning'});
    $.post({
        url: 'plugins/EcogazSync/core/ajax/EcogazSync.ajax.php',
        data: {
            action: 'refreshEcogaz'
        },
